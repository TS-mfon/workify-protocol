...
contract DeployV3 is Script {
    ...
    function run() external returns (BaseTreasuryV2 treasury, WorkEscrowV3 escrow) {
        ...
        escrow = new WorkEscrowV3(BASE_SEPOLIA_USDC, address(treasury), owner, attestor, operator);
        vm.stopBroadcast();
    }
}
