...
export function getGenLayerNetworkConfig(network: GenLayerNetwork = "bradbury"): GenLayerNetworkConfig {
  if (network === "studionet") {
    return {
      ...
      verifiers: {
        GITHUB_SOFTWARE: envAddress("STUDIO_NET_GITHUB_VERIFIER_ADDRESS", process.env.NEXT_PUBLIC_STUDIO_NET_GITHUB_VERIFIER_ADDRESS),
        WEB_APPLICATION: envAddress("STUDIO_NET_WEB_VERIFIER_ADDRESS", process.env.NEXT_PUBLIC_STUDIO_NET_WEB_VERIFIER_ADDRESS),
        RESEARCH_DATA: envAddress("STUDIO_NET_RESEARCH_VERIFIER_ADDRESS", process.env.NEXT_PUBLIC_STUDIO_NET_RESEARCH_VERIFIER_ADDRESS),
        CONTENT_DOCUMENT: envAddress("STUDIO_NET_DOCUMENT_VERIFIER_ADDRESS", process.env.NEXT_PUBLIC_STUDIO_NET_DOCUMENT_VERIFIER_ADDRESS),
        DESIGN_CREATIVE: envAddress("STUDIO_NET_DESIGN_VERIFIER_ADDRESS", process.env.NEXT_PUBLIC_STUDIO_NET_DESIGN_VERIFIER_ADDRESS),
      },
