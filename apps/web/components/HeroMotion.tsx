...
export function HeroMotion() {
  ...
  return <motion.div aria-hidden style={{ x:sx,y:sy,position:"fixed",top:0,left:0,width:22,height:22,border:"1px solid rgba(46,230,123,.45)",borderRadius:"50%",pointerEvents:"none",zIndex:100,boxShadow:"0 0 24px rgba(46,230,123,.2)" }}/>;
}
