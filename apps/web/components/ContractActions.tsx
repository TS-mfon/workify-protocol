...
const studioTreasury = (process.env.NEXT_PUBLIC_STUDIO_NET_GEN_TREASURY_ADDRESS || "0xFd682C098E88b1900BD5a6a68cAac43A6b1f5C13") as `0x${string}`;
const treasury = typeof window !== "undefined" && window.localStorage.getItem("workify-genlayer-network") === "studionet" ? studioTreasury : network.genTreasury;
const base = [
